...
DEFAULT_GPS_REQUEST_TIMEOUT_SECONDS = 45
...
LOCATION_CACHE_PATH = PROJECT_DIR / "roomai_location_cache.json"
LOCAL_MEMORY_PATH = PROJECT_DIR / "roomai_memory.db"
ACTION_LOG_PATH = PROJECT_DIR / "roomai_actions.log"
APP_LOG_PATH = PROJECT_DIR / "roomai.log"
...
class AppConfig:
    ...
    gps_request_timeout_seconds: int
    history_turns: int
...
def get_config() -> AppConfig:
    return AppConfig(
        ...
        gps_request_timeout_seconds=max(
            10,
            int(os.getenv("ROOMAI_GPS_REQUEST_TIMEOUT_SECONDS", str(DEFAULT_GPS_REQUEST_TIMEOUT_SECONDS))),
        ),
